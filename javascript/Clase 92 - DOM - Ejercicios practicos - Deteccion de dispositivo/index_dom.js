...
d.addEventListener("DOMContentLoaded", e=>{
    ...
    //La deteccion de dispositivo sirve por ejemplo para poder realizar web design responsive, al
    //saber en que tipo de dispositivo se encuentra el usuario
    //lo mismo ocurre cuando por ejemplo se lee el tipo de navegador que esta utilizando un usuario
    //podemos decirle que habria ciertas funcionalidades que no funcionen correctamente en su navegador
    //Hay aplicaciones que no tienen un responsive design, si no que lo que se hace es crear una aplicacion
    //paralela a la que se redirecciona por ejemplo si se entro desde un movil. La forma de reconocer el 
    //dispositivo es con la deteccion de dispositivo
