...
export default function userDeviceInfo(id){
    ...
    $id.innerHTML = `
    <ul>
        <li style="list-style:none;">User Agent: <b>${ua}</b></li>
        <li style="list-style:none;">Plataforma: <b>${isMobile.any()?isMobile.any():isDesktop.any()}</b></li> <!--Operador ternanio-->
    </ul>
    `;
    ...
    if(isDesktop.windows()){
        $id.innerHTML += `<p><mark>Este contenido solo se ve en window</mark></p>`;
    }
