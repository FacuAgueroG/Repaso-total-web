...
d.addEventListener("DOMContentLoaded", e=>{
    ...
    /*****************************SmartVideo**********************/
    //Es un script para que el video no se reproduzca cuando no esta en foco
    //Tanto si no esta en foco dentro de la misma pagina
    //Como si me fui a otra pestaña del explorador
    smartVideo();
});
